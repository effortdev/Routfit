...
export default function RecentBodyFatTrend({ entries }: Props) {
    ...
    return (
        <div className="bg-panel border border-line rounded-card p-4">
            <h3 className="text-sm font-medium text-paper/70 mb-3">최근 3일 체지방률</h3>
            <div className="flex gap-2">
                {recent.map((entry, i) => (
                    ...
                    >
                        ...
                        <span className={`text-lg font-display font-semibold ${i === recent.length - 1 ? 'text-moss' : 'text-paper'}`}>
